    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card-body pb-0">
                    ...
                    <tbody>
                      <?php while($usuario = $sql_query->fetch_assoc()){ ?>
                        <tr>
                          ...
                          <?php if($_SESSION['adm'] == 2 && $usuario['id'] !== $_SESSION['id']){ ?>
                            <td style="padding: 10px;">
                              <form action="usuarios.php?id=<?php echo $usuario['id']; ?>" method="post" style="display: inline;">
                                <button type="submit" class="btn btn-danger btn-rounded btn-fw" onclick="return confirm('Tem certeza que deseja deletar este usuário?');">Deletar</button>
                              </form>
                            </td>
                          <?php } else { ?>
          ...
          <?php if($_SESSION['adm'] == 2){ ?>
            <div class="card  mb-3">
              <a href="register-2.php">
                <button type="button" class="btn btn-success btn-lg btn-block">
                  <i class="mdi mdi-account">Cadastrar Novo</i>
                </button>
              </a>
              <br>
              <br>
