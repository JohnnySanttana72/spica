        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="auth">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"> <a class="nav-link" href="../../pages/samples/register-2.php"> Cadastrar ADM </a>
              </li>
          ...
          <ul class="navbar-nav mr-lg-2">
            <li class="nav-item nav-search d-none d-lg-block">
              <div class="input-group">
                ...
                <button style="position:absolute; top:19%; left:340%;" id="searchButton" type="button"
                  class="btn btn-success btn-rounded btn-fw">Buscar</button>
              </div>
            </li>
          </ul>
          <ul class="navbar-nav navbar-nav-right">
        ...
        function mostrarDepoimentos(depoimentos) {
          ...
          depoimentos.forEach(function (depoimento) {
            ...
            div.innerHTML = '<div class="card mb-3">' +
              ...
              "</p>" +
              "<p style=\"padding: 10px; text-align: left;\"><strong>Depoimento: </strong>" + depoimento
              .depoimento + "</p>" +
              "<br>" +
              "</thead>" +
              "</table>" +
